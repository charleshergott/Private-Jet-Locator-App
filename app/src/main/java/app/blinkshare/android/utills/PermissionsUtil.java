...
public class PermissionsUtil {
    ...
    public static String MEDIA = Manifest.permission.ACCESS_MEDIA_LOCATION;
    ...
    static String mediaPermInfoMsg = "App needs this permission to access your library. Are you sure you want to deny this permission ?";
    static String mediaPermErrorMsg = "Media Permission denied. You can enable permission from settings";
        ...
        if (grantResults.length > 0
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context, permission)) {
                ...
                if (permission.equals(STORAGE))
                    ...
                    alertBuilder.setMessage(contactsPermInfoMsg);
                else if (permission.equals(MEDIA))
                    alertBuilder.setMessage(mediaPermInfoMsg);
                ...
                if (permission.equals(STORAGE))
                    ...
                    Toast.makeText(context,mediaPermErrorMsg,Toast.LENGTH_LONG).show();
